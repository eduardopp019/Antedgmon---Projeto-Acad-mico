      ...
      <main class="ms-auto col-lg-10 px-md-4">
        ...
        <div class="card">
          ...
          <div class="card-header d-flex justify-content-between">
            ...
            <h4 class="m-0">Desenvolvedora</h4>
          ...
          $sql = "SELECT id_desenvolvedora FROM desenvolvedora";
            ...
            <div class="row">
              ...
              <div class="col-4">
                ...
                <form action="">
                  ...
                  <input type="search" name="nome" id="nome" class="form-control" placeholder="Pesquise por desenvolvedora...">
