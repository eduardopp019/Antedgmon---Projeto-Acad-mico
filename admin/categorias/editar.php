                            ...
                            <form action="acoes.php" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="categoria" id="categoria" class="form-control" maxlength="100" required value="<?php echo $categoria['nome'] ?>">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="1" <?php echo ($categoria['status'] == 1) ? 'selected' : '' ?>>Ativo</option>
                                            <option value="0" <?php echo ($categoria['status'] == 0) ? 'selected' : '' ?>>Inativo</option>
