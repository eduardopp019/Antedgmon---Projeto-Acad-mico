            ...
            <main class="ms-auto col-lg-10 px-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <h4 class="m-0">Nova Desenvolvedora</h4>
                        ...
                        <form action="acoes.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="desenvolvedora" id="desenvolvedora" class="form-control" maxlength="100" required>

                                    <input type="hidden" name="cadastrar" value="cadastrar_desenvolvedora">
